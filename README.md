...
1. [`versiyon-1.0.0/insta-follow-kit.js`](versiyon-1.0.0/insta-follow-kit.js) dosyasının **tamamını** kopyalayın. GitHub’da [sürüm klasöründeki dosyayı](https://github.com/bahadir-b-bekdemir/insta-follow-kit/blob/main/versiyon-1.0.0/insta-follow-kit.js) açıp **Raw** görünümünden `Ctrl+A` → `Ctrl+C` en pratik yöntemdir (veya ham bağlantı: `https://github.com/bahadir-b-bekdemir/insta-follow-kit/raw/main/versiyon-1.0.0/insta-follow-kit.js`).
...
```
versiyon-1.0.0/insta-follow-kit.js
